...
export default function SideBar() {
    ...
    return (
        <div className="flex flex-col bg-[#042235] h-screen w-20 absolute z-10">
            <div className='h-fit'>
                ...
                <Link href="/contacts">
                    <a className={`h-20 w-20 flex flex-row justify-center items-center ${router.pathname == "/contacts" ? "bg-[#2995DA]" : ""} `}>
                        <svg width="32" height="28" viewBox="0 0 32 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={`fill-slate-600  ${router.pathname == "/contacts" ? "fill-white" : "opacity-30"} `}>
                ...
                <Link href="/reports">
                    <a className={`h-20 w-20 flex flex-row justify-center items-center ${router.pathname == "/reports" ? "bg-[#2995DA]" : ""} `}>
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className={`fill-slate-600  ${router.pathname == "/reports" ? "fill-white" : "opacity-30"} `}>
